...
def main() -> None:
    ...
    desk.lidar_motor1.set_frequency(10)
    desk.lidar_motor1.set_amp_threshold(10000,40)
    desk.lidar_motor2.set_min_max(40,150)
    desk.lidar_motor2.set_frequency(10)
    desk.lidar_motor2.set_amp_threshold(10000,40)
